...
class TaskInteractor(
    ...
    fun getTasks(filterQuery: TaskQueryParams? = null): List<TaskWithOfferUsersModel> {
       return taskRepository.getAllTasksWithOfferUsers(filterQuery) ?: listOf<TaskWithOfferUsersModel>()
    }
